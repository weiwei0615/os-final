...
class Thread {
  ...
  public:
    Thread(char* debugName, int threadID, int Pri);		// initialize a Thread 
    ...
    double getApproximated_CpuBurst() { return approximated_CpuBurst; }
    int getCpuBurst() { return CpuBurst; }
    void updateCpuBurst(bool Yield);
    void resetCpuBurst() { CpuBurst = 0; }
    void guessNextBurst();
    void setStartTime();
    int getStartTime(){ return startTime; }
    void updateYieldCount() { YieldCount += 1; }
    void resetYieldCount() {YieldCount = 0;}
    int getYieldCount() { return YieldCount; }
    void aging();
